...
import arr.armuriii.ccl.script.json.constructor.JsonConstructorComponent;
...
public class JsonComponentsImpl {
    ...
    public static JsonConstructorFactory<?> getConst(String s) {
        Identifier identifier = s.contains(":") ? Identifier.splitOn(s,':') : CustomCraftingLibrary.id(s);
        return REGISTERED_CONSTRUCTORS.get(identifier);
    }
